...
extension SheetHandler {
    ...
    func getBookListByGradeAndBookDesign(grade: EikenGrade, bookDesign: BookDesign) -> Book {
    ...
    private func filterCards(_ cards: [Card], by pos: Pos, for bookDesign: BookDesign) -> [Card] {
