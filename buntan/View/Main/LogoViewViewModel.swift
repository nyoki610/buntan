...
class LogoViewViewModel: ObservableObject {
    ...
    private func fetchLatestVersionId() async {
        ...
        do {
            ...
            let latestDBVersionId = try await RemoteConfigRepository.shared.string(.latestDBVersionId)
    ...
    private func fetchLatestCards(versionId: String) async {
        ...
        do {
            ...
            try sheetService.syncSheetCards(for: .first, with: response.firstGradeCards)
            try sheetService.syncSheetCards(for: .preFirst, with: response.preFirstGradeCards)
            /// To delete unnecessary objects generated by old app versions
            let deleteUnnecessaryObjectsUseCase = DeleteUnnecessaryObjectsUseCase()
            try? deleteUnnecessaryObjectsUseCase.execute()
